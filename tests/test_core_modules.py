...
from src.features.features import compute_salience_normalized_velocity, OriginSafeStandardizer
...
def test_zero_leakage_enforcement():
    ...
    leaked_slice = pd.DataFrame([{"observation_id": "bad", "first_available_timestamp": datetime(2026, 6, 5)}])
