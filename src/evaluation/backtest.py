...
class RollingOriginBacktester:
    ...
    def __init__(self, horizons: List[int] = None, min_train_size: int = 50, cost_loss_ratio: float = 0.2):
    ...
    def run_backtest(
        self, df_features: pd.DataFrame, target_series: pd.Series, step_size: int = 1, anchor_indicator: str = "vix"
    ) -> pd.DataFrame:
        """
