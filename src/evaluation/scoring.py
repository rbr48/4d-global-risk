...
def compute_brier_skill_score(
    probabilities: np.ndarray, outcomes: np.ndarray, climatology_prob: Optional[float] = None
) -> float:
    """
...
def compute_logarithmic_score(probabilities: np.ndarray, outcomes: np.ndarray, epsilon: float = 1e-15) -> float:
    """
...
def compute_expected_calibration_error(
    probabilities: np.ndarray, outcomes: np.ndarray, num_bins: int = 10
...
def compute_relative_value_score(
    probabilities: np.ndarray, outcomes: np.ndarray, cost_loss_ratio: float, threshold: Optional[float] = None
) -> float:
    """
